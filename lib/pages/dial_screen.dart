...
// https://github.com/diegogarciar/twilio_voice
class DialScreen extends StatefulWidget {
  const DialScreen({super.key});

  @override
  DialScreenState createState() => DialScreenState();
}

class DialScreenState extends State<DialScreen> with WidgetsBindingObserver {
  ...
  register() async {
    ...
    if (Platform.isAndroid) {
      androidToken = ''; //TODO await FirebaseMessaging.instance.getToken();
  ...
  void pushToCallingScreen() {
    Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(fullscreenDialog: true, builder: (context) => CallingScreen()));
  }
}
